...
<div class="card col-sm-4">
	<div class="card-body">
	<div class="card-title bg-success text-light text-center"><h1>Edit Product</h1></div>
	<form:form action="/updateProduct" method="post" modelAttribute="product">
	<div class="form-group">
		<label for="pid">Product_Id</label>
		<form:input type="number" path="pid" placeholder="Enter Product ID" class="form-control" disabled="true"/>
	</div>
	<div class="form-group">
		<form:input type="hidden" path="pid" placeholder="Enter Product ID" class="form-control"/>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<button type="submit" class="btn btn-primary text-light"><i class="bi bi-life-preserver"></i> Update</button>
